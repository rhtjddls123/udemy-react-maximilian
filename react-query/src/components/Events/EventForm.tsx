...
import { FetchErrorType, ImageType, InputDataType } from "../../types/type.js";
...
export default function EventForm({ inputData, onSubmit, children }: EventFormProps) {
  ...
  const { data, isPending, isError, error } = useQuery<ImageType[], FetchErrorType>({
    queryKey: ["events-images"],
    queryFn: fetchSelectableImages
  });

  function handleSelectImage(image: InputDataType["image"]) {
